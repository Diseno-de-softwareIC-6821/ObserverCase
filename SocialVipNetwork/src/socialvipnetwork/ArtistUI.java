 ...
 * @author Esteb
 */
public class ArtistUI extends javax.swing.JFrame {

    /**
     * Creates new form ArtistUI
     */
    Artist me;
    public ArtistUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArtistUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
